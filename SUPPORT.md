...
- **Documentation problems:** open a GitHub Issue with the documentation template.

Security reports must follow [SECURITY.md](SECURITY.md). Do not post vulnerability details in
public channels.
