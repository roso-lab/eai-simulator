...
<td colspan="2">
  <p align="center">
    <a href="https://www.rosolab.com/roso-lab/eai-simulator/docs/environments.html">
      <img src="docs/source/assets/media/可视化.gif" alt="Composing an environment in the Env DIY visual editor" width="32%">
      <img src="docs/source/assets/media/插件.gif" alt="Preparing and running an environment in the Env DIY 3D plugin" width="32%">
      <img src="docs/source/assets/media/终端.gif" alt="Composing an environment with the Env DIY terminal workflow" width="32%">
    </a>
  </p>
